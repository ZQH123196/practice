...
CREATE TABLE `permission`  (
    ...
    `resource_type` varchar(100) DEFAULT NULL COMMENT 'role、user、menu、page、btn',
    ...
    update_by         varchar(50)     default ''                 comment '更新者',
    update_time       datetime                                   comment '更新时间',
    UNIQUE INDEX `idx_permission` (`id` ASC, `expression` ASC, `resource_type` ASC) USING BTREE,
    PRIMARY KEY (`id`, `expression`) USING BTREE
